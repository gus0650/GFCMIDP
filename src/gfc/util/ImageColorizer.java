...
public class ImageColorizer {
	...
	public final Image currentImage() {
		/*config:debug:OFF*///System.out.println("ImageColorizer.currentImage()");
	...
	public final void loadSource( String filename ) {		
		/*config:debug:OFF*///System.out.println("ImageColorizer.loadSource(): " + filename );
	...
	private final void loadSourceFromStream( InputStream is, int size ) {
		/*config:debug:OFF*///System.out.println("ImageColorizer.loadSourceFromStream() " + size);
	...
	public final void loadPaletteFromPLTEFile( String filename ) {
		/*config:debug:OFF*///System.out.println("ImageColorizer.loadPaletteFromPLTEFile() " + filename);
	...
	public final void loadPaletteFromPNGFile( String filename ) {		
		/*config:debug:OFF*///System.out.println("ImageColorizer.loadPaletteFromPNGFile() " + filename);
